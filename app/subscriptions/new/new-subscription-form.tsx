...
import { createSubscriptionAction, type NewSubscriptionState } from "./actions";
  ...
  useEffect(() => {
    ...
    const confirmed = window.confirm(
      state.duplicateMessage ??
        "Такая подписка уже есть в вашем списке. Добавить еще одну?",
    );
    ...
    <form ref={formRef} action={formAction} className={styles.form}>
      ...
      <div className={styles.iconField}>
        ...
        <p className={styles.iconHint}>
          {isUploading ? "Загружаем..." : "Нажмите, чтобы загрузить логотип"}
        </p>
