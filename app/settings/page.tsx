...
const GlobeIcon = () => (
    <svg viewBox="0 0 24 24" className={styles.rowIconSvg} aria-hidden>
        ...
        <path
            d="M3.8 12h16.4M12 3.5c2.2 2.5 3.3 5.4 3.3 8.5S14.2 18 12 20.5C9.8 18 8.7 15.1 8.7 12S9.8 6 12 3.5Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.6"
        />
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.group}>
                        <SettingsRow
                            ...
                            value="Вкл"
                        />
                        <SettingsRow icon={<GlobeIcon />} title="Язык и валюта" subtitle="RU / ₽" value="RU / ₽" />
