                    ...
                    <div className={styles.group}>
                        <button className={styles.row} type="button" disabled>
                            ...
                            <span className={styles.rowText}>
                                Р С’Р Р…Р В°Р В»Р С‘РЎвЂљР С‘Р С”Р В° РЎР‚Р В°РЎРѓРЎвЂ¦Р С•Р Т‘Р С•Р Р†
                            </span>
                            <Chevron />
                        </button>
                    </div>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.group}>
                        <button className={styles.row} type="button" disabled>
                            ...
                            <span className={styles.rowText}>
                                Р С™Р С•Р Р…РЎвЂћР С‘Р Т‘Р ВµР Р…РЎвЂ Р С‘Р В°Р В»РЎРЉР Р…Р С•РЎРѓРЎвЂљРЎРЉ
                            </span>
                            <Chevron />
                        </button>
                        ...
                        <button className={styles.row} type="button" disabled>
                            ...
                            <span className={styles.rowText}>
                                Р РЋР В»РЎС“Р В¶Р В±Р В° Р С—Р С•Р Т‘Р Т‘Р ВµРЎР‚Р В¶Р С”Р С‘
                            </span>
                            <Chevron />
                        </button>
                    </div>
